...
class ContextMenu(tk.Toplevel):
    def __init__(self, parent, config: ContextMenuConfig, style_prefix="ContextMenu", enable_shortcuts=True):
        ...
        self._init_styles()
        self._apply_shadow()  # Apply shadow if enabled
    ...
    def _apply_shadow(self):
        # Add a subtle drop shadow if enabled
    ...
    def _populate_menu(self):
        ...
        for i, item in enumerate(self.menu_items):
            ...
            if self.config_obj.show_icons:
                ...
                # Use the new icon_title_spacing to adjust the space after the icon
            ...
            # Right-aligned shortcut label using title_accelerator_spacing for left padding
    ...
    def _select_item(self, event):
        if self._selected_index is not None and self.buttons[self._selected_index]:
            # Simulate a button click by running its command
...
# ===============================================================
# Main Application Code for Demonstration
# ===============================================================
if __name__ == "__main__":
    ...
    def theme_toggle():
        new_theme = "alt" if style.theme_use() == "clam" else "clam"
        style.theme_use(new_theme)
        cm.menu._init_styles()
        app_logger.debug("🎨 Theme toggled.")

    # Define menu items using the dataclass
    menu_items = [
        MenuItem("Copy", copy_function, "global.png", "<Control-c>"),
        MenuItem("Paste", paste_function, "paste.png", "<Control-v>"),
        MenuItem("---"),
        MenuItem("Exit with a long title", root.quit, "exit.png", "<Alt-F4>"),
    ]
    ...
    def update_animation():
        ...
        app_logger.debug("⌨️ Animation updated to: " + new_animation)
